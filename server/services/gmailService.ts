...
if (!gmailEmail || !gmailAppPassword) {
  console.warn(
    "Warning: Gmail credentials not configured. Email sending will be simulated."
  );
}
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <div class="warning">
            <strong>Security Notice:</strong> If you didn't request this code, please contact our support team immediately. Someone may be trying to access your account.
          </div>
          <p>
